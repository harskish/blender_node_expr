...
# 1.34 29/10/2020 : Fix bug in Mandelbulb preset by providing Mandelbulb2 and fix issue to allow ':condition: ...' text to include ':'
# 2.00 06/10/2021 : Attempt to extend to other node systems#
# 2.02 19/05/2022 : Make compatible with Blender 3.1+ and activate in other node systems (Compositor and Geometry). Enhance preset system
#                   to allow presets to be specific to certain node system. Add 'Test' presets. Provide button to convert an expression
#                   to a text block based on its current text (note that it's not parsing the nodes).
##################################################################################################################
